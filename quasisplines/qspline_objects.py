...
# This file was *autogenerated* from the file qspline_objects.sage
...
class IdealDifferenceConditions:
    ...
    def __init__(self, s, J):
        self.sheet_number = s 
        self.coefficient_ring = J(_sage_const_0 ,_sage_const_0 ).ring()
    ...
    def sheet_number(self, s):
        if not (s.is_integer() and s >_sage_const_0 ): raise Exception("sheet_number must be a positive integer")
    ...
    def is_spline(self, g):
        ...
        for p in [(i,j) for j in range(s) for i in range(j)]:
            if not (g[p[_sage_const_0 ]] - g[p[_sage_const_1 ]] in J(p[_sage_const_0 ],p[_sage_const_1 ])):
                return False
        return True
...
class QuasiSplineModule:
    ...
    def __init__(self, smg):
        ...
        self.coefficient_ring = smg[_sage_const_0 ][_sage_const_0 ].parent()
...
class QuasiSplineRing:
    ...
    def __init__(self, QSM = None):
        ...
        CR = QSM.gens()[_sage_const_0 ][_sage_const_0 ].parent()
...
def QSM_from_IDC(IDC = None):
    ...
    s = IDC.sheet_number
    CR = J(_sage_const_0 ,_sage_const_0 ).ring()
